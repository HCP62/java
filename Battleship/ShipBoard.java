...
/*
HW for Thursday:
Fix naming of x and y in both the code and the user input request
Don't read in an int. Read it in as a string and convert to int only if appropriate. (Use try catch and Integer.parseInt, or regex)
Read in vertical or horizontal on the same line like x and y
*/
package Juni;
